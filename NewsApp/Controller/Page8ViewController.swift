...
//https://news.yahoo.co.jp/rss/media/lettucec/all.xml
...
class Page8ViewController: UITableViewController,SegementSlideContentScrollViewDelegate,XMLParserDelegate {
    ...
    override func viewDidLoad() {
         ...
         */
        //      ⑩ urlを入れる
        let urlString = "https://news.yahoo.co.jp/rss/media/lettucec/all.xml"
